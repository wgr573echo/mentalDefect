...
def main():
    ...
    tr_dataloader = init_dataloader(options, 'train') # 82240 items 4112 class
    val_dataloader = init_dataloader(options, 'val') # 13760 items 688 class
    # trainval_dataloader = init_dataloader(options, 'trainval')
    test_dataloader = init_dataloader(options, 'test') # 33840 items 1692 class
